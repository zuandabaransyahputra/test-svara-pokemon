...
import { usePokemonInfo } from "../hooks/PokemonContext";
import { types } from "../data/allTypes";
import CardPokemonContext from "./CardPokemonContext";
...
const PokemonContext = () => {
  ...
  const allPokemons = usePokemonInfo();
